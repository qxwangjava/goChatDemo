...
type SendMsgReq struct {
	...
	ToUserId        string `protobuf:"bytes,1,opt,name=toUserId,proto3" json:"toUserId,omitempty"`      // 用户ID
	...
	MessageType     int32  `protobuf:"varint,4,opt,name=messageType,proto3" json:"messageType,omitempty"`         // type 消息类型，默认是 1 - text 2-image
	MessageContent  string `protobuf:"bytes,5,opt,name=messageContent,proto3" json:"messageContent,omitempty"`    // 消息内容
	MessageServerId int64  `protobuf:"varint,6,opt,name=messageServerId,proto3" json:"messageServerId,omitempty"` //消息id
	FromId          string `protobuf:"bytes,8,opt,name=fromId,proto3" json:"fromId,omitempty"`                    //发送者人id
	FromType        int32  `protobuf:"varint,9,opt,name=fromType,proto3" json:"fromType,omitempty"`               //发送者类型 1 用户 2-群
	GroupId         int64  `protobuf:"varint,10,opt,name=groupId,proto3" json:"groupId,omitempty"`                //群id
}
...
func (x *SendMsgReq) GetToUserId() string {
	if x != nil {
		return x.ToUserId
	}
	return ""
...
func (x *SendMsgReq) GetMessageServerId() int64 {
	if x != nil {
...
func (x *SendMsgReq) GetFromId() string {
	if x != nil {
		return x.FromId
	}
	return ""
...
func (x *SendMsgReq) GetFromType() int32 {
	if x != nil {
		return x.FromType
	}
	return 0
...
var file_pkg_proto_im_proto_rawDesc = []byte{
	...
	,
	...
	,
...
var file_pkg_proto_im_proto_goTypes = []interface{}{
	(*CloseConnReq)(nil), // 0: pb.closeConnReq
	(*CloseConnRsp)(nil), // 1: pb.closeConnRsp
	(*SendMsgReq)(nil),   // 2: pb.sendMsgReq
	(*SendMsgRsp)(nil),   // 3: pb.sendMsgRsp
}
var file_pkg_proto_im_proto_depIdxs = []int32{
	0, // 0: pb.ImServer.closeConn:input_type -> pb.closeConnReq
	2, // 1: pb.ImServer.sendMsg:input_type -> pb.sendMsgReq
	1, // 2: pb.ImServer.closeConn:output_type -> pb.closeConnRsp
	3, // 3: pb.ImServer.sendMsg:output_type -> pb.sendMsgRsp
...
func (c *imServerClient) CloseConn(ctx context.Context, in *CloseConnReq, opts ...grpc.CallOption) (*CloseConnRsp, error) {
	...
	err := c.cc.Invoke(ctx, "/pb.ImServer/closeConn", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *imServerClient) SendMsg(ctx context.Context, in *SendMsgReq, opts ...grpc.CallOption) (*SendMsgRsp, error) {
	out := new(SendMsgRsp)
	err := c.cc.Invoke(ctx, "/pb.ImServer/sendMsg", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func _ImServer_CloseConn_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/pb.ImServer/CloseConn",
	}
...
func _ImServer_SendMsg_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/pb.ImServer/SendMsg",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
